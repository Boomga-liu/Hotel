// RWD時的效果
window.onscroll = scroll_showPrice;

function scroll_showPrice(e) {
...
window.ontouchmove = touch_showPrice;

function touch_showPrice(e) {
	let price = document.querySelectorAll('.price');
	let scrollY = e.path[6].scrollY;

	// console.log(scrollY);
	// console.log(e.path[6].scrollY);
